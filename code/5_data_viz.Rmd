...
save_plot(path(output_dir,
               str_c("TE_analysis/2024_01_TE/FDR0.1/LFC0.5/single_gene_plots/Cluster_",
                     as.character(i), "_short_legend.pdf")),
          p_list[[i]])
}
...
p_grid <- ggarrange(plotlist = p_list, ncol=1, align = "hv") 
#p_grid <- annotate_figure(p_grid, 
                         # top = "Average cpm",
                          #bottom = "Polysome Pool")
save_plot(path(output_dir,
               "TE_analysis/2024_01_TE/FDR0.1/LFC0.5/single_gene_plots/heatmap_clusters/compiled_cluster_grid.pdf"),
          p_grid,
...
write.csv(as.matrix(LSG6h_only),
          path(output_dir,
               "TE_analysis/2024_01_TE/FDR0.1/LFC0.5/correlation_plots/mRNA/TE_up_mRNA_noChange_genes_LFC0.5_sigFDR0.1_LSG6h_UNIQUE.csv"))
write.csv(as.matrix(LSG6h),
          path(output_dir, 
               "TE_analysis/2024_01_TE/FDR0.1/LFC0.5/correlation_plots/mRNA/TE_up_mRNA_noChange_genes_LFC0.5_sigFDR0.1_LSG6h.csv"))
...
#TE v mRNA and TE v protein correlation
```{r}
